...
def call(Map parameters = [:], body) {
    ...
    def mavenImage = parameters.get('mavenImage', 'arilivigni/maven-builder:latest')
    def jnlpImage = (flow.isOpenShift()) ? 'arilivigni/jenkins-slave-base-centos7:latest' : 'jenkinsci/jnlp-slave:2.62'
